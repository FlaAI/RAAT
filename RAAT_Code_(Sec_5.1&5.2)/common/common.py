...
def parse_args(default=False):
    ...
    parser.add_argument('--lam', help='regularization parameter for consistency (including BD)',
                        default=1.0, type=float)
    parser.add_argument('--T', help='temperature scaling (including BD)',
                        default=0.5, type=float)

    ##### BD Configurations #####
    parser.add_argument("--BD", help='apply BD',
                        action='store_true')
    parser.add_argument('--BD_boundary_range', help='hyper-parameter boundary_range for BD',
                        default=0.1, type=float)
    parser.add_argument('--BD_alpha', help='hyper-parameter ALPHA for BD',
